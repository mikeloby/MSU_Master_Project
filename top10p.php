<?php
	...
	if($save1=="Yes"){
		 ...
		 for ($i=0; $i <$num_results; $i++) {
						...
						if($sid==$iduser && $scriteria==$category && $syear==$year){
								 $csave=1;
						}
		  }

			if($csave==0){
						$query = "insert into saveq2 values(0,'$iduser','$category','$year')";
						$result= $db->query($query);
			}
	}
...
<body>
  ...
  <div id="coverteams2">
  <div class="btn-group">
  <button class="button1"><a href = "/teams/load5.php">Return previous screen</button>
