...
<?php
  ...
  $iduser=$_SESSION['vuser'];
   ...
   if (!get_magic_quotes_gpc()){
    $team1 = addslashes($team1);
    $team2 = addslashes($team2);
  ...
  $csave=0;
    ...
    if($save1=="Yes"){
       ...
       for ($i=0; $i <$num_results; $i++) {
              ...
              $steam1= stripslashes($row['team1']);
              $steam2= stripslashes($row['team2']);
              $scriteria= stripslashes($row['criteria']);
              $syear= stripslashes($row['year']);
              if($sid==$iduser && $steam1==$team1 && $steam2==$team2 && $scriteria==$criteria && $syear==$year){
                   $csave=1;
              }
              
              if($sid==$iduser && $steam1==$team2 && $steam2==$team1 && $scriteria==$criteria && $syear==$year){
                   $csave=1;
              }
        ...
        if($csave==0){
              $query = "insert into saveq values(0,'$iduser','$team1','$team2','$criteria','$year')";
              $result= $db->query($query);
        }
    }
  ...
  <div class="btn-group">
  <button class="button1"><a href = "/teams/load3.php">Return previous screen</button>
